...
/*
 * Colorama is crafted by David Gauld. The library is inspired by several other
 * color JavaScript libraries, however, Colorama is designed to fit the needs
 * of anyone wanting to work with advanced color manipulation. Also, Colorama
 * includes several different palette templates, allowing you to easily create
 * a great looking palette from a single color. Need something that isn't
 * included? Contribute! http://github.com/dcgauld/colorama.
 */
